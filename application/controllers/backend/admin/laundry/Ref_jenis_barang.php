...
class Ref_jenis_barang extends MY_controller
{

    public function __construct()
    {
        parent::__construct();
        $this->path = 'backend/admin/laundry/ref_jenis_barang/';
        $this->table = 'ref_jenis_barang';
    ...
    {
        $data = [
            'title' => 'Referensi Jenis barang',
            'li_active' => 'laundry_ref_jenis_barang',
            'li_open' => 'laundry',
