...
<script>
    function submit_data(form) {
        ...
        var id_estimasi = $(form).data('idestimasi');
        var val = $(form).val();

        var data = new FormData();
        data.append('id_barang', id_barang);
        data.append('id_estimasi', id_estimasi);
        data.append('val', val);
                ...
                if (res.status == 'success') {
                    ...
                    $.map(row, function(e, i) {
                        ...
                        <div class="form-group">
                            <label>${e.jenis}</label>
                            <div>
                                <input type="text" value="${formatRupiah(''+e.harga)}" onchange="submit_data(this)" class="form-control data_rupiah" data-idbarang="${id}" data-idestimasi="${e.id}" placeholder="masukkan data">
                            </div>
                        </div>
                        `;
                    });
