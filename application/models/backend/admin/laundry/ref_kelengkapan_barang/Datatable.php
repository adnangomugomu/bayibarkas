...
{
    var $table = 'ref_kelengkapan a'; //jenis tabel dari database
    var $column_order = array(null, 'a.id_ref_jenis_barang', 'a.nama', null); //field yang ada di table user
    var $column_search = array('a.jenis', 'a.nama'); //field yang diizin untuk pencarian
    ...
    private function _get_datatables_query()
    {
        ...
        $this->db->join('ref_jenis_barang b', 'b.id = a.id_ref_jenis_barang', 'left');        
