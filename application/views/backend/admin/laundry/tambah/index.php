                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-group">
                                    <input name="merk" autocomplete="off" type="text" class="form-control" placeholder="Masukkan nama pelanggan">
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-group">
                                    <textarea name="alamat" rows="6" class="form-control" placeholder="Masukkan alamat pelanggan"></textarea>
                                </div>
                            </div>
